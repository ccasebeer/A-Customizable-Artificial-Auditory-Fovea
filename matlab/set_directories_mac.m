...
directory_setup.mat_test_dir = '~/Desktop/tensorflow_temp/mat_test_files'
...
directory_setup.mat_test_results_dir = '~/Desktop/tensorflow_temp/mat_test_results'

%Test set data. Classes organized by folder name. 
directory_setup.test_data_directory = '../test_data'

%Directory where Tensorflow will dump its data. 
%This directory will get occasionally very very large. 
directory_setup.tf_output_dir = '~/Desktop/tensorflow_temp/'
